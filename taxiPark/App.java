...
public class App {
   ...
   int choice;
       ...
       try {
           ...
           switch(choice){
               case 1: System.out.println("Введите количество автопарков, которое хотите создать");
                        quantityOfParks =Integer.parseInt(sc.next());
                        for(int i=0; i<quantityOfParks; i++){
                           createTaxiPark(i);}break;
                            
               case 2:  manipulateTaxiPark(); break;
           }
...
//   Метод создает таксопарк
    public static void createTaxiPark(int i){
       int j = i + 1;    
        ...
        userQuantityOfCars =Integer.parseInt(sc.next());
   ...
   public static void manipulateTaxiPark(){
       ...
       System.out.println("2: Посмотреть все машины автопарка");
       System.out.println("3: Добавить машину");
       System.out.println("4: Убрать машину");
       ...
       switch(userChoice){
           case 1: showAllTaxiParks();break;
           case 2: Car.fillWithRandomMarks(userQuantityOfCars); break;
           case 3:
           case 4:
           case 5:
           case 6:
